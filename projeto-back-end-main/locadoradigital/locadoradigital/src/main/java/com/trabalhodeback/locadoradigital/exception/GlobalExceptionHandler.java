...
@ControllerAdvice
    public class GlobalExceptionHandler {
        ...
        // Tratamento para MovieNotFoundException
        @ExceptionHandler(MovieNotFoundException.class)
        public ResponseEntity<ApiError> handleMovieNotFoundException(BookNotFoundException ex) {
            ApiError apiError = new ApiError();
            apiError.setCode("Movie-001");
            apiError.setStatus(404);
            apiError.setMessage("Filme não encontrado: " + ex.getMessage());
